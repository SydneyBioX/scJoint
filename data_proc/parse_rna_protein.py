...
data_path = "../data/pbmc_control_citeseq_adt_matrix_log.txt"
label_path = "../data/pbmc_control_citeseq_cellTypes.csv"
label_to_idx_path =  "../data/label_to_idx.txt"
output_path = "../data/data_v0/rna_protein_v0/"
