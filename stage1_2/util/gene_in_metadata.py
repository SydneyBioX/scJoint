...
def make_dataset(atac_path, rna_path, atac_protein_path, rna_protein_path):
    ...
    return data_atac, data_rna, data_atac_protein, data_rna_protein, labels_atac_cell, labels_rna_cell
...
class MINCDataloder(data.Dataset):
    def __init__(self, atac_path, rna_path, atac_protein_path, rna_protein_path, train=True, transform=None, rna_or_atac='atac'):
        ...
        self.train = train
        self.atac_data, self.rna_data, self.atac_protein, self.rna_protein, self.labels_atac, self.labels_rna = make_dataset(atac_path, rna_path, atac_protein_path, rna_protein_path)
    ...
    def __getitem__(self, index):
        if self.train:
            ...
            atac_label = self.labels_atac[rand_idx]
